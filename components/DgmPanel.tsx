    ...
    return (
        <div className="animate-fade-in-up">
            <div className="text-center mb-10">
                <h2 className="text-3xl font-bold text-indigo-300">Meta-Orchestration Controller (DGM)</h2>
                <p className="mt-2 text-lg text-indigo-200/80 max-w-3xl mx-auto">
                    Initiate an architectural adaptation cycle. The system will design a meta-orchestration layer for dynamic, real-time reconfiguration of resources and agent tasking.
                </p>
            </div>
                ...
                >
                    {isLoading ? (
                        ...
                        <>
                            ...
                            Initiate Architectural Adaptation
                        </>
                    )}
                </button>
            </div>
            ...
            {result && !isLoading && (
                 <div className="mt-10 bg-gray-800/50 border border-green-500/30 rounded-lg p-6 backdrop-blur-sm shadow-2xl shadow-green-500/10 space-y-4 animate-fade-in-up">
                    <h3 className="text-xl font-bold text-green-300 text-center">Architectural Adaptation Proposal Generated</h3>
                    <ResultCard title="Analysis of Current Architecture">
                        <p>{result.analysis}</p>
                    </ResultCard>
                    <ResultCard title="Proposed Meta-Orchestration Layer">
